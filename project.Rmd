...
caravan_insurance$has4Or5Houses = ifelse(caravan_insurance$MAANTHUI == 4 | caravan_insurance$MAANTHUI == 5, 1, 0)
caravan_insurance$moreThan5Houses = ifelse(caravan_insurance$MAANTHUI > 5, 1, 0)
...
dat <- data.frame(
  policy_status = factor(c("averageFamily", "loners", "conservativeFamilies", "crusingSeniors", "drivenGrowers", "grownups", "framers", "livingWell", "retired", "successful"), levels=c("averageFamily", "loners", "conservativeFamilies", "crusingSeniors", "drivenGrowers", "grownups", "framers", "livingWell", "retired", "successful")),
