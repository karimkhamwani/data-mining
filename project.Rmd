...
```{r}
over_test$PPERSAUT = as.numeric(over_test$PPERSAUT)
over_train$PPERSAUT = as.numeric(over_train$PPERSAUT)
```

```{r}

glm_5 = glm(formula = CARAVAN ~ MOSTYPE + PPERSAUT + MKOOPKLA+MAUT1+MHKOOP, family = binomial(link = "logit"), 
    data = over_train)
